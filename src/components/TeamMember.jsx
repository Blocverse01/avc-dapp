      ...
      <div className="lg:grid grid-cols-2 mt-10 place-items-center gap-6">
        <div className="p-8 backdrop-blur-md w-fit mx-auto rounded-[14px] glass-bg">
          <img
            ...
            className="w-full h-auto md:w-[434px] md:h-[591px] lg:w-full object-cover"
            alt={validMember.name}
          />
        </div>

        <div className="w-full md:text-[20px] backdrop-blur-md leading-[24x] md:leading-[27px] mx-auto xl:mb-20 mb-20 xl:mt-0 mt-10 xl:text-[18px] font-[400]   text-white">
